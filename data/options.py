...
def option():
    ...
    parser.add_argument('--data_train_lol_v1'       , type=str, default='/content/drive/MyDrive/OKLab/datasets/LOLdataset/our485')
    ...
    parser.add_argument('--data_val_lol_v1'         , type=str, default='/content/drive/MyDrive/OKLab/datasets/LOLdataset/eval15/low')
    ...
    parser.add_argument('--data_valgt_lol_v1'       , type=str, default='/content/drive/MyDrive/OKLab/datasets/LOLdataset/eval15/high/')
    ...
    parser.add_argument('--val_folder', default='/content/drive/MyDrive/OKLab/results/', help='Location to save validation datasets')
