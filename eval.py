...
if __name__ == '__main__':
    ...
    if not os.path.exists('/content/drive/MyDrive/OKLab/output'):          
            os.mkdir('/content/drive/MyDrive/OKLab/output')  
    
    norm_size = True
    num_workers = 1
    alpha = None
    if ep.lol:
        eval_data = DataLoader(dataset=get_eval_set("/content/drive/MyDrive/OKLab/datasets/LOLdataset/eval15/low"), num_workers=num_workers, batch_size=1, shuffle=False)
        output_folder = '/content/drive/MyDrive/OKLab/output/LOLv1/'
        if ep.perc:
            weight_path = '/content/drive/MyDrive/OKLab/weights/LOLv1/w_perc.pth'
        else:
            weight_path = '/content/drive/MyDrive/OKLab/weights/LOLv1/wo_perc.pth'
        ...
        if ep.DICM:
            ...
            output_folder = '/content/drive/MyDrive/OKLab/output/custome/'
        alpha = ep.alpha
        norm_size = False
