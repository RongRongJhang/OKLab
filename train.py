...
def checkpoint(epoch):
    if not os.path.exists("/content/drive/MyDrive/OKLab/weights"):          
        os.mkdir("/content/drive/MyDrive/OKLab/weights") 
    if not os.path.exists("/content/drive/MyDrive/OKLab/weights/train"):          
        os.mkdir("/content/drive/MyDrive/OKLab/weights/train")  
    model_out_path = "/content/drive/MyDrive/OKLab/weights/train/epoch_{}.pth".format(epoch)
...
def build_model():
    ...
    if opt.start_epoch > 0:
        pth = f"/content/drive/MyDrive/OKLab/weights/train/epoch_{opt.start_epoch}.pth"
...
if __name__ == '__main__':  
    ...
    with open("/content/drive/MyDrive/OKLab/results/training/metrics.md", "w") as f:
